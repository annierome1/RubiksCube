...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            int limitHash = 5; // Adjust as needed

            // Initialize the BackTree with the limits
            BackTree backTree = new BackTree(limitBFS, limitHash);

            // Initialize the FrontTree with the backTree
            FrontTree frontTree = new FrontTree(backTree);
            ...
            boolean found = backTree.DFS(solvedState, 10); // Adjust depth limit as needed
